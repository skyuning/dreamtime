<template>
  <div class="settings-fields">
    <p class="notification">
      If you change any of these options please restart the program to avoid problems.
    </p>
    ...
    <section class="box box-section">
      <box-section-item
        ...
        <button type="button" class="button" @click.prevent="changeCLI">
          📂
        </button>
      </box-section-item>
      ...
      <box-section-item
        ...
        <button type="button" class="button" @click.prevent="changeModels">
          📂
        </button>
      </box-section-item>
      ...
      <box-section-item
        ...
        <button type="button" class="button" @click.prevent="changeCropped">
          📂
        </button>
      </box-section-item>
      ...
      <box-section-item
        ...
        <button type="button" class="button" @click.prevent="changeMasks">
          📂
        </button>
      </box-section-item>
    </section>
